...
//        return result != -1;
    ...
    public Boolean insertInventory(Integer book_id, Integer library_id){
        SQLiteDatabase MyDB = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(INVENTORY_BOOK, book_id);
        contentValues.put(INVENTORY_LIBRARY, library_id);
    ...
    public Boolean deleteInventory(String id){
        SQLiteDatabase MyDB = this.getWritableDatabase();
        long result = MyDB.delete(INVENTORY_TABLE,"id = ?", new String[]{id});
        return result != -1;
    }

    public Boolean insertCreative(Integer book_id, Integer author_id){
        SQLiteDatabase MyDB = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(CREATIVE_BOOK, book_id);
        contentValues.put(CREATIVE_AUTHOR, author_id);
        long result = MyDB.insert(CREATIVE_TABLE, null, contentValues);
        return result != -1;
    }

    public Boolean deleteCreative(String id){
        SQLiteDatabase MyDB = this.getWritableDatabase();
        long result = MyDB.delete(CREATIVE_TABLE,"id = ?", new String[]{id});
        return result != -1;
    }
